...
class Turnstile(Producer):
    ...
    def __init__(self, station):
        ...
        #
        super().__init__(
                        f"com.udacity.cta.{station_name}", # TODO: Come up with a better topic name
    ...
    def f_asdict(self, p_num_entries):
        return {'station_id' : self.station.station_id,
    ...
    def run(self, timestamp, time_step):
        ...
        self.producer.produce(
                            ...
                            value=self.f_asdict(num_entries),
